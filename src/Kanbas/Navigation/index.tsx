...
import "./index.css";
import { FaTachometerAlt, FaRegUserCircle, FaBook, FaRegCalendarAlt, FaHistory, FaPrint, FaTv } from "react-icons/fa";
...
function KanbasNavigation() {
  const links = [
    ...
    { label: "Help",  icon: <IoMdHelpCircleOutline className="fs-2 red-icon" /> },
  ];
